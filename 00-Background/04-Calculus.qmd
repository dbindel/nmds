...
infinitely differentiable in a neighborhood of $z_0$.  Functions that
are real analytic in the neighborhood of a point are also complex
analytic in a neighborhood.  Complex analyticity around a point
(existence of a convergent Taylor series) and the property of being
holomorphic around a point (having complex derivatives that satisfy
the Cauchy-Riemann equations) are equivalent to each other.
